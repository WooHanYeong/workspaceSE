package lang;import javax.sound.sampled.spi.AudioFileReader;
...
public class StringUseMain {
	...
	public static void main(String[] args) {
		...
		if (isVaild) {
			System.out.println(userId + "는 유효한아이디입니다");
		}else {
			System.out.println(userId + "는 유효한아이디입니다");
		}
		...
		String email = "guad@gamil.com";
		int atSignPotision = email.indexOf("@");
		System.out.println(atSignPotision);
		System.out.println(email.substring(0,atSignPotision));
		System.out.println(email.substring(atSignPotision+1));
		
		
		System.out.println("--------------split------------------");
		String phoneNo = "010 -5648 -5132";
