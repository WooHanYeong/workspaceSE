...
abstract class  AbstractParent{
	public void method1() {
		System.out.println("AbstractParent 난 구상(Concrete)메쏘드");
	}
...
class AbstractChild extends AbstractParent{
	...
	@Override
	public void method2() {
		System.out.println("AbstractChild에서 AbstractParent의 추상메쏘드 method2재정의[implement(구현)]");
...
public class AbstractParentChildMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		AbstractChild abstractChild2=new AbstractChild();
