...
public class AcademyMemberTypeCastingMAain {
	...
	public static void main(String[] args) {
		...
		AcademyMember의 자식객체 (AcademyStudent ,AcademyGangsa ,AcademyStaff)들은
		...
		*/
		...
		/*************AcademyMember에 정의되지않는 메쏘드 호출불가능.****************
		 String ban = m1.getBan();
		 ********************************************************************/
		/*** AcademyMember에 정의된 메쏘드중 재정의된메쏘드호출가능 *****
		  -AcademyMember 타입에 정의된 print메쏘드를 호출하면
		  - AcademyMember의 자식타입객체의 재정의 print메쏘드가호출된다.
