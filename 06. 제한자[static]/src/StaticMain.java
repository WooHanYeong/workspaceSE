...
public class StaticMain {
	...
	System.out.println("static1.instance : " + static1.instance_field);
	static1.instance_mathod();
	
	
	Static static2 = new Static();
	System.out.println(">>static2객체주소 : " + static2);
	static2.instance_field=2222;
	System.out.println("static2.instance : " + static2.instance_field);
	static2.instance_mathod();
